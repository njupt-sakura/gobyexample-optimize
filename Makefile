...
init: ## Initial commit
	rm -rf ./.git
	git init
	git remote add origin git@github.com:njupt-sakura/gobyexample-optimize.git
	git add -A
...
.PHONY: build
build: ## Go build
	rm -rf ./target && mkdir ./target ./src/dir
	echo "hello go" > ./src/dir/file.txt
	echo "123"      > ./src/dir/file1.hash
	echo "456"      > ./src/dir/file2.hash
